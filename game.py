...
# lista af texture og texture sem er spegluð
...
#klassa spilara sem erfðir sprite klassan  
class Player(arcade.Sprite):
    def __init__(self, player_lives=3):
        ...
        self.textures = load_texture_pair("data/ninja.png")
...
class Enemy(arcade.Sprite):
    def __init__(self):
        ...
        self.textures = load_texture_pair("data/roomba.png")
        self.texture = self.textures[1]
        self.scale = 0.05
    def update(self):
...
class Leikur(arcade.Window): # klassi fyrir leikinn
    def __init__(self):
        ...
        super().__init__(screen_width, screen_height, "Bitcoin miner - crypto")
    ...
    def setup(self):
        ...
        #3 bitcoin
        star = arcade.Sprite("data/bitcoin.png")
    ...
    def on_draw(self):
        ...
        if self.start:
            ...
            arcade.draw_text("Bitcoin ninja",3400, 500, arcade.color.BLUE, 40)
        
        # ef player vinnur þá fer þetta í gang
        elif self.dead:
        ...
        # valmöguleikar breytt erfiðleika
        elif self.menu:
            arcade.set_background_color(arcade.color.AIR_FORCE_BLUE)
            if self.val2 == 0:
    ...
    def update(self, delta_time):
        if self.game:
            ...
            # checka hvort leikmaður hreyfist úr limit
            changed = False
